                                    ...
                                    <div class="mb-3">
                                        ...
                                        class="select2 form-control @error('account_id') is-invalid @enderror">
                                            ...
                                            @foreach( $accounts as $account )
                                            	<option @if($license->account_id == $account->id) selected="selected" @endif value="{{ $account->id }}">{{ $account->name }}</option>
                                            @endforeach 
                                        </select>
                                        @error('account_id')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        class="select2 form-control @error('product_id') is-invalid @enderror">
                                            ...
                                            @foreach( $products as $product )
                                            	<option @if($license->product_id == $product->id) selected="selected" @endif  value="{{ $product->id }}">{{ $product->product_name }}</option>
                                            @endforeach 
                                        </select>
                                        @error('product_id')
                                            <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                            		<div class="mb-3">
                                        ...
                                        value="{{ $license->activation_limit }}" id="activation_limit" name="activation_limit"  
                                        min="1">
